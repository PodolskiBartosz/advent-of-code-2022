...
# Conditions:
# - In a given file there are two sections seperated by an empty line, crates section and rearrangement section
# - Crates Section is a 9 by 9 table, with vertical stacks and horizontal levels; The bottom level describes a stack
#   with numbers from  1 to 9; Other levels are filled with crates represented by capital letters surrounded by
#   squared brackets; Lack of bracket is represented by three empty spaces
